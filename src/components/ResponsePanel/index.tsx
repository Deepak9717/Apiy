        ...
        {isPending && (
          ...
          >
            <div className="relative w-10 h-10">
              ...
              />
              <div className="absolute inset-0 border-2 border-zinc-200 dark:border-zinc-700 border-t-orange-500 rounded-full animate-spin" />
            </div>
          ...
          >
            ...
            <div className="flex items-center gap-3 px-4 py-3 border-b border-zinc-200 dark:border-zinc-800 flex-wrap gap-y-1.5">
                  ...
                  >
                    {activeTab === tab && (
                      <motion.div
                        ...
                        className="absolute inset-0 bg-zinc-200 dark:bg-zinc-700 rounded"
              ...
              <motion.button
                whileTap={{ scale: 0.9 }}
                onClick={copy}
                className="text-xs text-zinc-400 hover:text-orange-500 dark:text-zinc-600 dark:hover:text-orange-400 transition-colors"
              >
                {copied ? '✓ Copied' : 'Copy'}
              </motion.button>
            </div>
                    ...
                    <tbody>
                      {Object.entries(response.headers).map(([key, value]) => (
                        <tr key={key} className="border-b border-zinc-100 dark:border-zinc-800/50">
                          <td className="py-1.5 pr-4 text-orange-500 dark:text-orange-400/70 align-top w-2/5">{key}</td>
